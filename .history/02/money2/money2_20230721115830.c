...
x_100_text_pos = (WINDOW_X_SIZE / 6) + ((WINDOW_X_SIZE / 6) - x_100_text_size) /
                                           2;  // 文字(100)の位置を計算
...
x_5_text_pos = (WINDOW_X_SIZE / 6) * 4 + ((WINDOW_X_SIZE / 6) - x_5_text_size) /
                                             2;  // 文字(5)の位置を計算

x_1_text_pos = (WINDOW_X_SIZE / 6) * 5 + ((WINDOW_X_SIZE / 6) - x_1_text_size) /
                                             2;  // 文字(1)の位置を計算
