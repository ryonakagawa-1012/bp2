...
void money_draw(int kind, int sum) {
    ...
    switch (kind) {
        case 500:
            img = HgImageLoad("image/money_coin_reiwa_500.png");
            break;

        case 100:
            img = HgImageLoad("image/money_coin_100.png");
            break;

        case 50:
            img = HgImageLoad("image/money_coin_50.png");
            break;

        case 10:
            img = HgImageLoad("image/money_coin_10.png");
            break;

        case 5:
            img = HgImageLoad("image/money_coin_5.png");
            break;

        case 1:
            img = HgImageLoad("image/money_coin_1.png");
            break;
    };

    HgImagePut(500 + (kind - 500) * 100, 300, img, 1, 0);
    HgImageUnload(img);
}